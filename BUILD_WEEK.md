...
1. Start a real event research flow from a URL, description, or screenshot, or use a clearly labelled fictional sample event.
...
- Grounded event research from a URL, description, or screenshot, plus a context-aware research chat that clearly marks missing facts rather than inventing speakers.
...
- Vercel Production: `NEXT_PUBLIC_SUPABASE_URL`, `NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY`, `SUPABASE_URL`, and `SUPABASE_SECRET_KEY`.
